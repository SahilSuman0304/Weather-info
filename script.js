function validate() {
  ...
  if (inputLocation.value !== "" && acesskey.value !== "") {
    ...
    const token = "56ZKQJLPLHQ8RHS9RHGL8Z5YX";
    ...
    //const url=`https://api.weatherstack.com/current?access_key=${token}&query=${loc}`;
    console.log(url);
    ...
    document.getElementsByTagName("h1")[0].innerHTML = "no result";
  }
}